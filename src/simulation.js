...
export function groundAt(x,rampLevel=0){
 ...
 if(x<RAMP_END){const t=(x+18)/32,t2=t*t,t3=t2*t,end=15+rampLevel*3.1,tangent=13.4+rampLevel*3.5;return(2*t3-3*t2+1)*17+(t3-2*t2+t)*-48+(-2*t3+3*t2)*end+(t3-t2)*tangent}
